...
declare variable $_:include := "/db/system/repo/schematron-exist-1.1.0/content/iso-schematron/iso_dsdl_include.xsl";
declare variable $_:expand := "/db/system/repo/schematron-exist-1.1.0/content/iso-schematron/iso_abstract_expand.xsl";
declare variable $_:compile1 := "/db/system/repo/schematron-exist-1.1.0/content/iso-schematron/iso_svrl_for_xslt1.xsl";
declare variable $_:compile2 := "/db/system/repo/schematron-exist-1.1.0/content/iso-schematron/iso_svrl_for_xslt2.xsl";
